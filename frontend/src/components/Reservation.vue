  ...
  <v-container>
    ...
    <v-form ref="form">
      <v-row>
        ...
        <v-col cols="12" md="6">
          <v-text-field v-model="phone" label="핸드폰번호 : 숫자만 입력하세요" type="text" @keypress="isNumber"
        ...
        <v-container fluid>
          <v-row class="child-flex">
            ...
            <v-col cols="12" md="6">
              <v-toolbar dark>
                <v-spacer></v-spacer>
                <v-toolbar-title>보관</v-toolbar-title>
                <v-spacer></v-spacer>
              </v-toolbar>
            ...
            <v-col cols="12" md="6">
              <v-toolbar dark>
                <v-spacer></v-spacer>
                <v-toolbar-title>대여</v-toolbar-title>
                <v-spacer></v-spacer>
              </v-toolbar>
        ...
        <v-card>
          ...
          <v-card-text>
            ...
            <div>
              ...
              3. 보관되는 “물품”의 가치가 한 개(벌) 당 200,000원 이상의 고가품일 경우 회사는 보관을 거부할 수 있습니다. 만약 사전합의 없이 고객이 임의로 200,000원 이상의
              물품의
              보관을 요청하는 경우 회사는 물품에 대하여 최대 200,000원의 손해배상책임만을 부담합니다.<br>
            ...
            <div>
              ...
              1. 회사의 고의, 과실에 의하여 물품의 분실 및 손실이 발생한 경우, 고객과 사전협의가 되었다는 등의 특별한 사정이 없는 이상 회사는 물품 당 200,000원을 한도로 배상책임을
              부담합니다.<br>
            ...
            <div>
              ...
              ② 이 개인정보 취급방침은 2024. 12. 01부터 적용됩니다.
            </div>
          </v-card-text>
          <v-card-actions>
            <v-spacer></v-spacer>
